...
export const removeLineBreaksPageContent: TransformToolPageContent = {
  ...
  seoArticle: {
    ...
    paragraphs: [
      ...
      "Pair with duplicate-line removal only after deciding whether breaks carried meaning. Sometimes duplicates differ solely by wrap position; joining lines first clarifies uniqueness. Other times line order encodes steps you must preserve—choose tooling order thoughtfully.",
